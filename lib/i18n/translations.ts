...
const messages: Record<SupportedLocale, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    faqAWhatAppDoesOutro:
      '. The Pub Notebook works without an account: save places, add private notes, and filter by your own tags. Guest notes stay on this device. Sign in for a separate synced Notebook and your analysis history.',
    ...
    profileDefaultName: 'Member',
    profileGuestEyebrow: 'Profile',
    profileGuestTitle: 'Join the community',
    profileGuestBlurb:
      'Sign in to sync a private Notebook and keep your analysis history. You can already use the complete guest Notebook without an account.',
    profileGuestTeaser: 'Guest places and notes stay on this device. Signing in opens your separate account Notebook.',
    ...
    profileHubFavoritesEmpty: 'Plan places to visit and keep private notes',
    ...
    profileNavFavorites: 'Pub Notebook',
    ...
    pubDetailFavorite: 'Save to Notebook',
    pubDetailSaved: 'Remove from Notebook',
    pubDetailFavoriteBusy: '…',
    pubDetailFavoriteToastAdded: 'Saved to your Notebook. Add a private note from the Notebook tab.',
    pubDetailFavoriteToastRemoved: 'Removed from your Notebook.',
